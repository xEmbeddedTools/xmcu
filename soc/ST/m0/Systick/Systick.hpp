...
namespace soc {
namespace m0 {
class Systick : private xmcu::Non_copyable
{
public:
...
private:
    ...
    template<typename Periph_t, std::uint32_t periph_id> friend class xmcu::soc::peripheral;
...
namespace xmcu {
namespace soc {
template<std::uint32_t id> class peripheral<m0::Systick, id> : private xmcu::Non_constructible
{
public:
    static constexpr m0::Systick create()
    {
        return m0::Systick(0);
    }
};
